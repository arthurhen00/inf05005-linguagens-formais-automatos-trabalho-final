...
void remocaoEstadosInalcancaveis(ptLSE *map[],char estados[][32],char estadoInicial[8]);
...
void lerAutomato(char name[], char estados[][32], char alfabeto[][32], char estadoInicial[], char estadoFinal[][16], ptLSE *map[],int *qntEstados, int *qntSimbolos){
